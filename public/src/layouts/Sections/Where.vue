...
<template>
	<div class="WhereStep">
		...
		<div class="Where_Buttons">
			<button class="Button_Where" @mouseenter="preloadOnHover(StepLauncherOptimization)"
				@focus="preloadOnHover(StepLauncherOptimization)" @click="changeImage(StepLauncherOptimization)">
				<div class="Description">
					<p>
						Impulsado por <a href="https://github.com/NovaStepStudio/NovaCore-Engine" target="_blank">NovaCoreEngine</a>,
						StepLauncher alcanza velocidades extremas gracias a su sistema multihilo en Java.
						Descargá y prepará Minecraft en minutos: ~5 (aprox.) min para 1.12.2 y ~6.5 min (aprox.) para
						versiones recientes.
					</p>
				</div>

				<div class="TextMain"> <img src="../../../assets/svg/cards/bolt.svg" fetchpriority="low" loading="lazy">
					Rapidez </div>
			</button>

			<button class="Button_Where" @mouseenter="preloadOnHover(StepLauncherInstances)"
				@focus="preloadOnHover(StepLauncherInstances)" @click="changeImage(StepLauncherInstances)">
				<div class="Description">
					<p>
				...
				<div class="TextMain"> <img src="../../../assets/svg/cards/instance.svg" fetchpriority="low"
						loading="lazy"> Instancias</div>
			</button>

			<button class="Button_Where" @mouseenter="preloadOnHover(StepLauncherMods)"
				@focus="preloadOnHover(StepLauncherMods)" @click="changeImage(StepLauncherMods)">
				<div class="Description">
					<p>
						Explorá, descargá e instalá mods y modpacks fácilmente desde múltiples fuentes.
						Integración directa para ampliar tu experiencia sin procesos complicados ni configuraciones
						manuales.
					</p>
				</div>

				<div class="TextMain"> <img src="../../../assets/svg/cards/mod.svg" fetchpriority="low" loading="lazy">
					Modpacks y Mods </div>
			</button>

			<button class="Button_Where Security" @mouseenter="preloadOnHover(StepLauncherDashboard)"
				@focus="preloadOnHover(StepLauncherDashboard)" @click="changeImage(StepLauncherDashboard)">
				<div class="Description">
					<p>
						Gestión avanzada de cuentas integrada en StepLauncher.
						Iniciá sesión con múltiples perfiles (premium y no premium),
						cambiá entre ellos al instante y mantené tus datos organizados y sincronizados sin
						complicaciones.
						El sistema optimiza la autenticación y reduce tiempos de acceso para que entres a jugar sin
						esperas.
					</p>
				</div>

				<div class="TextMain"> <img src="../../../assets/svg/cards/shield.svg" fetchpriority="low"
						loading="lazy"> Cuentas </div>
			</button>
		</div>

		<div ref="containerRef" class="Images">
			<img :src="typeof displaySrc === 'string' ? displaySrc : displaySrc.src" decoding="async" loading="eager"
				fetchpriority="high">

			<StaticLight :container-ref="containerRef" :source="src" :options="{
				blur: 80,
				canvasBlur: 15,
				brightness: 1.2,
				saturation: 1.3,
