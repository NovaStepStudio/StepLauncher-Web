<template>
    <section class="friends">
        ...
        <div class="friends__search">
            <input v-model="searchQ" @keyup.enter="doSearch" class="friends__input"
        ...
        <div v-if="online.length" class="friends__section">
            ...
            <div v-for="f in online" :key="f.friend_id" class="friends__row">
                <div class="friends__av">
                    <img v-if="f.friend_avatar_url" :src="f.friend_avatar_url" />
        ...
        <div v-if="reqReceived.length" class="friends__section">
            <h3><span v-html="Icons.received"></span> Solicitudes recibidas <span class="badge">{{ reqReceived.length}}</span></h3>
            <div>
        ...
        <div v-if="reqSent.length" class="friends__section">
            <h3><span v-html="Icons.inbox"></span> Enviadas <span class="badge">{{ reqSent.length }}</span></h3>
